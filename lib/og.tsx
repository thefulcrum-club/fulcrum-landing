...
// single-instance TTFs pre-instantiated via fonttools (varLib.instancer) from
// the same upstream sources, checked into assets/fonts.
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", fontFamily: "Playfair Display", fontStyle: "italic", fontWeight: 600, fontSize: 30, color: "#f5f5f5" }}>
            fulcrum<span style={{ color: "#6187ec" }}>.</span>
          </div>
        </div>
